...
void Gameround::smallblind(Player& player)
{
    player.stack -= sblind;
    player.bet = sblind;
...
void Gameround::bigblind(Player& player)
{
    player.stack -= bblind;
    player.bet = bblind;
...
void Gameround::sturn(Player& who)
{
...
void Gameround::sraise(Player& who)
{
...
void Gameround::scall(Player& who)
{
    int amount = highestbet - who.bet;
    ++counter;
    if (who.stack < amount)
...
void Gameround::sfold(Player* who)
{
...
void Gameround::raise(Player& who)
{
...
void Gameround::call(Player& who)
{
    int amount = highestbet - who.bet;
    ++counter;
    if (who.stack < amount)
...
void Gameround::fold(Player* who)
{
    std::cout << "I'm out. \n";
...
void Gameround::turn(Player& who)
{
...
void Gameround::potdivider(int win, std::vector<int> tie)
{
    if (tie.empty() == true)
    {
